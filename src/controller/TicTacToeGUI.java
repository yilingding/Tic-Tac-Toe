...
public class TicTacToeGUI extends JFrame {
	...
	private TextAreaView textFieldView;
	...
	public TicTacToeGUI() {
		...
		textFieldView = new TextAreaView(theGame, width, height);
	...
	private void setupMenus() {
		...
		menu.add(views);
		JMenuItem button = new JMenuItem("JButton");
		JMenuItem graph = new JMenuItem("JGraph");
		views.add(button);
		views.add(graph);
		JMenuItem textField = new JMenuItem("JTextField");
		views.add(textField);
		// Set the menu bar
		...
		textField.addActionListener(menuListener);
		button.addActionListener(menuListener);
		graph.addActionListener(menuListener);
	}
